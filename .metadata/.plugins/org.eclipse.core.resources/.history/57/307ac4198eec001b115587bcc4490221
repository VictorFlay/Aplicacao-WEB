		...
		try {
			while(rs.next()) {
				...
				saida += "       <div class=\"row justify-content-center mt-2\">\r\n" + 
						...
						"							<div class=\"col-5\">\r\n" + 
						"		  						Nome da companhia aérea: " + rs.getString("empresa") +
						"							</div>\r\n" + 
						"							<div class=\"col-4\">\r\n" + 
		...
		try {
			while(rs.next()) {
				saida += "       <div class=\"row justify-content-center mt-2\">\r\n" + 
						...
						"	  					<div class=\"row justify-content-center\">\r\n" + 
						"							<div class=\"col-5\">\r\n" + 
						"		  						Nome da companhia aérea: " + "<input type=\"text\" class=\"form-control\" placeholder=\"Digite o nome da companhia:\" name=\"cxnome\" id=\"cxnome\">" +
						"							</div>\r\n" + 
						"							<div class=\"col-4\">\r\n" + 

...
<body>
	...
	<div class="container-fluid px-0">
		...
		<div class="row justify-content-center mt-4">
			<div class="col-6 col-lg-3 text-center h2">Adicionar Linha Aérea</div>
		</div>

		<div class="row justify-content-center mt-5">
			<div class="col-6 col-lg-5 text-center h3">Formulário para adicionar linha</div>
		</div>

		<!-- Formulário para adicionar uma companhia aérea -->
		<div class="row justify-content-center mt-2">
...
<!-- Apenas administrador tem acesso a essa página -->

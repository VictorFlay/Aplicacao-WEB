...
<body>
	...
	<div class="container-fluid px-0">
		...
		<!-- Botão para retornar para o meu principal -->
		...
		<div class="row justify-content-center mt-4">
			<div class="col-6 col-lg-3 text-center h2">Adicionar Localização</div>
		</div>

		<div class="row justify-content-center mt-5">
			<div class="col-6 col-lg-5 text-center h3">Formulário para adicionar o país</div>
		</div>

		<!-- Form para insert o país (AJAX) -->
		<div class="row justify-content-center mt-2">
						...
						<form id="localizacao-form" method="POST">
							<div class="form-row">
								<div class="form-group col-md-4">
									<label for="nome" class="h6">Nome do país e lugar:</label> <input
										type="text" class="form-control" id="cxnome" name="cxurl"
										placeholder="Exemplo (Brasil, São Paulo)">
								</div>
		...
		<!-- Exibe todas as localizações do banco de dados -->
		<div class="row">
			<%

...
<body>
	...
	<div class="container-fluid px-0">
		...
		<div class="row justify-content-center mt-5">
			<div class="col-3 col-lg-3 text-center h2">Alteração</div>
		</div>

		<div class="row justify-content-center mt-5">
			<div class="col-6 col-lg-3 text-center h3">Linha Aérea Original
			</div>
		</div>

		<!-- Exibe a linha aérea selecionada -->
		<%
		...
		<!-- Exibe um formulário para alterar a linha aérea -->
		<%
...
<!-- Apenas ADM pode acessar essa tela caso ao contrário é mandado de volta para o index -->

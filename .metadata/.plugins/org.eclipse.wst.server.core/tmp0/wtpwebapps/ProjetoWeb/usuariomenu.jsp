...
<body>
	...
	<div class="container-fluid px-0">
		...
		<div class="row justify-content-center mt-4">
			<div class="col-6 col-lg-3 text-center h2">Menu Usuário</div>
		</div>

		<div class="row justify-content-center mt-5">
			<div class="col-6 col-lg-5 text-center h3">Usuários</div>
		</div>
...
<!-- Apenas o administrador tem acesso a essa página -->

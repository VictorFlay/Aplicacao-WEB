...
<body>
	...
	<div class="container-fluid px-0">
		...
		<div class="row">
			<div class="col-8 col-lg-9 justify-content-between mt-4 ml-2"
				id="mensagem">"Seu primeiro destino é aqui"</div>
							...
							<div class="modal-body">
								<form method="POST" id="register-form">
									<div class="alert alert-danger center" role="alert" id="erro">
										Nome ou Login já cadastrado!</div>
									<div class="form-group">
										<label for="nome" class="col-form-label">Nome
											Completo:</label> <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome completo">
									</div>

									<div class="form-group">
										<label for="login" class="col-form-label">Login:</label> 
										<input type="text" class="form-control" id="cxlogin" name="cxlogin" placeholder="Login">
									</div>

									<div class="form-group">
										<label for="senha" class="col-form-label">Senha:</label> <input
											type="password" class="form-control" id="cxsenha" name="cxsenha" placeholder="Senha">
									</div>
	...
	<form method="POST" id="buscar-form">
		<div class="row mt-4">
			...
			<div class="col-3 col-lg-3 classe mt-4 ml-5">
				...
				<div class="jss33">
					Qual classe você deseja viajar ?
				</div>
	...
	<!-- Mensagem de erro na tela na hora de efetuar uma busca -->

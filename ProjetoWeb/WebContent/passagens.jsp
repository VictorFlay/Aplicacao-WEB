...
<body>
	...
	<div class="container-fluid px-0">
		...
		<div class="row">
			...
			<!-- Contéudo que apenas o visitante tem acesso -->
			<% if (converte == 0) { %>
	...
	<form method="POST" id="buscar-form">
		<div class="form-row mt-5 ml-5">
			<div class="col-5 col-lg-3 buscarlocalizacao mt-4 ml-5">
				...
				<div class="jss30">
					<p>Buscar Localização disponível</p>
				</div>
	...
	<!-- Créditos -->
	<div class="row">
		<div class="col-lg-6 mt-2 invisible">Créditos: Kaique</div>
	</div>
